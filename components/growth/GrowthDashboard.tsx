  ...
  return (
    <div className="space-y-12 pb-10">
      <div className="flex justify-between items-end mb-2">
         <h1 className="text-3xl font-bold">用户与增长</h1>
         <span className="text-sm text-gray-500">用户获取 · 留存 · 社区生态</span>
      </div>
      
      {/* 1. User Acquisition & Active */}
      <section>
      ...
      {/* 2. Creator Growth (Supply Side Growth) */}
      <section>
      ...
      <section>
        <h2 className="text-2xl font-bold mb-6 flex items-center text-pink-400">
